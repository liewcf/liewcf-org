...
This repo powers `liewcf.org`, currently a static profile, five-Project catalog, and two-entry Updates publication surface generated by Astro from semantic HTML, CSS, vanilla browser JavaScript, and typed local Markdown content. Astro is the build and preview foundation; there is no server runtime, Tailwind, client-side UI framework, CMS, or blog.
