...
This repo powers `liewcf.org`, currently a static profile and Project catalog generated by Astro from semantic HTML, CSS, vanilla browser JavaScript, and typed local Markdown content. Astro is the build and preview foundation; there is no server runtime, Tailwind, client-side UI framework, CMS, blog, or published Updates yet.
