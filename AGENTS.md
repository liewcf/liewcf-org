...
This repo powers `liewcf.org`, currently a static one-page profile generated by Astro from plain semantic HTML, CSS, and vanilla browser JavaScript. Astro is the build and preview foundation; there is no server runtime, Tailwind, client-side UI framework, CMS, blog, or completed multi-page portfolio yet.
...
- `src/pages/index.astro` — the full one-page profile, metadata, outbound links, and vanilla browser behavior.
